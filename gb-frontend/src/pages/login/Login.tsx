        ...
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-5">
                <div className="text-center pb-8">
                    <img src="/src/assets/logo/grontho-bilash-transparent.png" width={150} className="mx-auto" />
                    <div className="mt-5">
                ...
                <p className="text-center">Don't have an account? <Link to='/signup' className="font-medium text-yellow-600 hover:text-yellow-500">Sign up</Link></p>
            </div>
        </main>
    )
}
