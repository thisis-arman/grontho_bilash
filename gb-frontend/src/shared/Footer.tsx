const Footer= () => {
    ...
    return (
        <footer className="pt-10 bg-yellow-50 bg-opacity-50 bg-gradient-to-t from-yellow-200 to-white">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                    ...
                    <div className="flex-1 mt-6 md:mt-0">
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                <svg className="w-6 h-6 text-gray-700 absolute left-3 inset-y-0 my-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-gray-800 bg-white outline-none border focus:border-yellow-600 shadow-sm rounded-lg"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-black bg-yellow-600 hover:bg-yellow-500 active:bg-yellow-700 active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex ">
                    <p className="text-gray-800">© 2022 Float UI Inc. All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-700 mt-6">
